...
All_Cites_Name = pd.read_csv("/opt/airflow/data/maroc_cities.csv")
with open("/opt/airflow/data/bronze/All_Cities_Bronze.json") as file :
...
df.to_csv("/opt/airflow/data/silver/All_Moroccain_Citys.csv" , index=False)
...
df.to_csv("/opt/airflow/data/gold/All_Moroccain_Citys.csv" , index=False)
